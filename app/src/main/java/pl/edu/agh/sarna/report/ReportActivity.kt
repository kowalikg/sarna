...
class ReportActivity : AppCompatActivity(), AsyncResponse {
    ...
    private val wrappedParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
    ...
    private fun insertFinishButton() {
        val button = Button(this)
        button.tag = R.string.wifi_title
        button.text = "Exit"
        ...
        reportLayout.addView(button, wrappedParams)
    }
    ...
    private fun initialiseLayout() {
        ...
        wrappedParams.setMargins(125, 20, 125, 0)
